...
* **Usage Rules:** You **may not** reproduce, distribute, display, or use my artwork or licensed fonts for commercial or personal purposes. If you fork this repository or copy the code, you must remove my personal artwork and the "ND Logos" font files and replace them with your own assets.
All artwork, illustrations, photographs, graphics, and written content hosted in this repository are **Copyright © 2026 Benjamin Counter. All rights reserved.** * You **may not** reproduce, distribute, display, or use my artwork for commercial or personal purposes without explicit written permission.
* **If you fork this repository or copy the code:** You must remove and replace all of my personal artwork, images, and specific portfolio text with your own content.
...
* **Discord username:** bryancontador